...
if(EXR_DEFLATE_LIB)
  ...
  if(OPENEXR_FORCE_INTERNAL_DEFLATE)
    message(STATUS "libdeflate forced internal, fetching from ${OPENEXR_DEFLATE_REPO} @ ${OPENEXR_DEFLATE_TAG}")
  else()
    message(STATUS "libdeflate was not found, fetching from ${OPENEXR_DEFLATE_REPO} @ ${OPENEXR_DEFLATE_TAG}")
  endif()
