...
function(OPENEXR_DEFINE_LIBRARY libname)
  ...
  if (OPENEXR_BUILD_APPLE_FRAMEWORKS)
    set_target_properties(${objlib} PROPERTIES
      FRAMEWORK TRUE
      FRAMEWORK_VERSION "${OPENEXR_LIB_VERSION}"
      XCODE_ATTRIBUTE_PRODUCT_BUNDLE_IDENTIFIER "org.aswf.OpenEXR"
      MACOSX_FRAMEWORK_IDENTIFIER "org.aswf.OpenEXR"
      MACOSX_FRAMEWORK_BUNDLE_VERSION "${OPENEXR_LIB_VERSION}"
      MACOSX_FRAMEWORK_SHORT_VERSION_STRING "${OpenEXR_VERSION}"
      MACOSX_RPATH TRUE)
  else()
    set_target_properties(${libname} PROPERTIES
  ...
  if(BUILD_SHARED_LIBS AND (NOT "${OPENEXR_LIB_SUFFIX}" STREQUAL "") AND NOT WIN32 AND NOT OPENEXR_BUILD_APPLE_FRAMEWORKS)
